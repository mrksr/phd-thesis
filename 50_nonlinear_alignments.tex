...
We view the power production of different wind-turbines as the outputs of a multi-output Gaussian process (MO-GP)~\parencite{alvarez_kernels_2011} that models the latent wind fronts.
