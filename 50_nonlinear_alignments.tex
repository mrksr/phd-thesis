\chapter{Non-linear time-series alignment}
\label{toc:alignment}
...
The bound can be calculated in $\Oh(NM^2)$ time and factorizes along the data points, enabling stochastic optimization.
...
\begin{figure}[tp]
    ...
    \caption[Wind-turbine experiment]{
        ...
        Note that the sign chance in the alignment signifies a change in prevailing wind conditions.
