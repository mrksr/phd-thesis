...
To reduce the number of required points, recent work explored how Bayesian infrence can be added to the search for good inducing point locations~\parencite{hensman_mcmc_2015,rossi_rethinking_2020}.
