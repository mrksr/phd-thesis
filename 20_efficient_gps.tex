...
The problem is therefore not a computational problem and asking for a solution or algorithm for this problem is not a well-posed question.
...
and
\tikz[x=2.5em,baseline=(y.base)]{
    \node[inline random variable, observed] (y) {$\mat{y}$};
}
...
Drawing samples of the likelihood directly elimates the need for Psi-statistics as in~\cref{eq:var_compression:full_bound}, making DSVI applicable to a broader set of hierarchical Gaussian process models.
