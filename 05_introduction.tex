...
\begin{figure}[tp]
    ...
    \caption[Comparison of model cultures]{
        ...
        The wite-box approach uses scientific understanding to formulate a detailed model that explains the process in nature and uses data to find values for few interpretable parameters.
