...
The goal of RL is to learn a policy which dynamically chooses actions in the environment to achieve a goal or behavior.
...
In this chaper, we show how we can alleviate some of the limitations of \parencite{deisenroth_pilco_2011} to provide a richer and more efficient RL model.
...
Thus, no special modeling is needed when applying NFQ to the Wet-Chicken benchmark and given enough data, NFQ is able to find successful policies.
...
In \cref{toc:interpretable_rl:policy_learning}, we compared our model to standard GPs and showed that modeling multi-modality is critical to solve Wet-Chicken.
