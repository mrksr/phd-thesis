...
\begin{axis}[
    ...
    \addplot[restrict, mean, sRedDark, name path=assign, opacity=0.4]
        table[ignore chars={\#}, col sep=space, x=X, y expr=\thisrow{a1}] {\datapath/cut_data_1.0.dat};
...
\begin{axis}[
    ...
    ] {\datapath/cut_data_1.0.dat};

    \addplot[restrict, std, first, name path=minus]
    table[ignore chars={\#}, col sep=space, x=X, y expr=\thisrow{mu} - \thisrow{2std}] {\datapath/cut_model_1.0_0.dat};
    ...
    table[ignore chars={\#}, col sep=space, x=X, y expr=\thisrow{mu} - \thisrow{2fullstd}] {\datapath/cut_model_1.0_0.dat};
    \addplot[restrict, std, first, name path=fullplus]
    table[ignore chars={\#}, col sep=space, x=X, y expr=\thisrow{mu} + \thisrow{2fullstd}] {\datapath/cut_model_1.0_0.dat};
    \addplot[restrict, first fill]
    fill between[of=fullplus and fullminus];
    \addplot[restrict, mean, first]
    table[ignore chars={\#}, col sep=space, x=X, y=mu] {\datapath/cut_model_1.0_0.dat};

    \addplot[restrict, std, second, name path=minus]
    table[ignore chars={\#}, col sep=space, x=X, y expr=\thisrow{mu} - \thisrow{2std}] {\datapath/cut_model_1.0_1.dat};
    \addplot[restrict, std, second, name path=plus]
    table[ignore chars={\#}, col sep=space, x=X, y expr=\thisrow{mu} + \thisrow{2std}] {\datapath/cut_model_1.0_1.dat};
    \addplot[restrict, second fill]
    fill between[of=plus and minus];
    \addplot[restrict, mean, second]
    table[ignore chars={\#}, col sep=space, x=X, y=mu] {\datapath/cut_model_1.0_1.dat};
\end{axis}
\end{tikzpicture}
\end{document}
