...
\label{toc:theory:dgp}

\subsection{Variational Approximation}
\label{toc:theory:dgp:variational_approximation}
...
\label{toc:theory:dgp:augmented_model}
...
\label{toc:theory:nvc:first_layer}
...
\label{toc:theory:nvc:other_layers}
...
In \cref{toc:theory:nvc:kernel_expectations} we show closed-form solutions for these $\Psi$-statistics for the implicit kernel defined in the CP layer.
...
\label{toc:theory:composite_uncertainties}
?
